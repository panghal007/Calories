...
const Register = () => {
   ...
   const handleSubmit2 = async(e) =>{
       ...
       const {username, email, password, age, height, weight, targetWeight,gender,lifestyle} = userData
       await axios.post('http://localhost:3000/api/register',{username, email, password, age, height, weight, targetWeight,gender,lifestyle})
